...
const Skills = () => {
    return (
        <div className="skills-section" style={{ width: '100%' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 32, flexWrap: 'wrap', width: '100%' }}>
                ...
                <span style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    >
                        ...
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" alt="Tailwind" width="48" height="48" />
                        </span>
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/redux/redux-original.svg" alt="Redux" width="48" height="48" />
                        </span>
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original-wordmark.svg" alt="HTML5" width="48" height="48" />
                        </span>
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original-wordmark.svg" alt="CSS3" width="48" height="48" />
                        </span>
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg" alt="Node.js" width="48" height="48" />
                        </span>
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/redis/redis-original-wordmark.svg" alt="Redis" width="48" height="48" />
                        </span>
                        <span>
                        ...
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mysql/mysql-original-wordmark.svg" alt="MySQL" width="48" height="48" />
                        </span>
                        <span>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original-wordmark.svg" alt="Docker" width="48" height="48" />
                        </span>
                        <span>
